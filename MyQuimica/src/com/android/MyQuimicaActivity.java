...
import com.android.informacoes.GerenciadorMistura;
import com.android.informacoes.Jogador;
import com.android.informacoes.Mistura;
...
IOnMenuItemClickListener, IOnAreaTouchListener{
	...
	private void comecar() {
		...
		this.textoFormulaQuimica = new Text(827, 540, this.fontInformacoes,"FÃ³rmula");
			...
			if (!mistura.equals(misturaDaVez.getComposicaoMistura())) {
				...
				this.runOnUiThread(new Runnable() {
					public void run() {
						...
						alert.setPositiveButton("PÅ•oximo Desafio",
								new OnClickListener() {
		...
		if (pKeyCode == KeyEvent.KEYCODE_MENU && pEvent.getAction() == KeyEvent.ACTION_DOWN) {
			...
			alert.setPositiveButton("SIM", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int whichButton) {
					Intent intent1=new Intent(MyQuimicaActivity.this, TelaMenuActivity.class); 
